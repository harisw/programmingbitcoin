...
class ECCTest(TestCase):
    ...
    def test_add(self):
        ...
        for target in additions:
            x1 = FieldElement(target[0], prime)
            y1 = FieldElement(target[1], prime)
            x2 = FieldElement(target[2], prime)
            y2 = FieldElement(target[3], prime)
            x3 = FieldElement(target[4], prime)
            y3 = FieldElement(target[5], prime)
            p1 = Point(x1, y1, a, b)
            p2 = Point(x2, y2, a, b)
            p3 = Point(x3, y3, a, b)
            if p1+p2 != p3:
